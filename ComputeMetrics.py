...
# Load the GT data
GT_PATH = "data_info/MNHT_rootmorphology_GT_v2.csv"
...
path_test = f"data_info/model_metrics_test_feat_gt_{feat_gt_file}.csv"
path_val = f"data_info/model_metrics_val_feat_gt_{feat_gt_file}.csv"
